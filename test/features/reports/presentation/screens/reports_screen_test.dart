...
void main() {
  ...
  group('ReportsScreen Widget Tests', () {
    ...
    testWidgets('shows empty state when no orders exist in selected period', (
      tester,
    ) async {
      await tester.pumpWidget(buildTestableWidget(const ReportsScreen()));
      await tester.pumpAndSettle();
    ...
    testWidgets(
      'switches to Financial Report tab and displays metrics and breakdowns',
      (tester) async {
    ...
    testWidgets(
      'tapping إضافة مصروف button in Financial Report opens AddExpenseDialog',
      (tester) async {
        await tester.pumpWidget(buildTestableWidget(const ReportsScreen()));
        await tester.pumpAndSettle();
        ...
        await tester.tap(
          find.byKey(const ValueKey('add_expense_quick_action_button')),
        );
        await tester.pumpAndSettle();
