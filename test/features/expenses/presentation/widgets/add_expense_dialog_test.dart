...
void main() {
  ...
  group('AddExpenseDialog Widget Tests', () {
    testWidgets('renders all initial fields, labels, and action buttons', (
      tester,
    ) async {
      await tester.pumpWidget(buildTestableWidget(const AddExpenseDialog()));
    ...
    testWidgets('shows validation error when amount is empty or non-positive', (
      tester,
    ) async {
      await tester.pumpWidget(buildTestableWidget(const AddExpenseDialog()));
      await tester.pumpAndSettle();
    ...
    testWidgets(
      'selecting category أخرى reveals expense name field and enforces validation',
      (tester) async {
        ...
        await tester.ensureVisible(
          find.byKey(const ValueKey('save_expense_button')),
        );
        await tester.pumpAndSettle();
        await tester.tap(find.byKey(const ValueKey('save_expense_button')));
        await tester.pumpAndSettle();
        ...
        expect(
          find.text('يرجى إدخال اسم المصروف عند اختيار تصنيف أخرى'),
          findsOneWidget,
        );
    ...
    testWidgets(
      'creates standard expense with notes and triggers onExpenseCreated callback',
      (tester) async {
