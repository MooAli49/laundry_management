...
void main() {
  group('Orders Presentation Widgets Tests', () {
    testWidgets('OrderStatusBadge renders correct Arabic status labels', (
      tester,
    ) async {
    ...
    testWidgets('OrdersFilterBar renders all filters and triggers selection', (
      tester,
    ) async {
    ...
    testWidgets(
      'OrderCard displays order number, customer, status, total and remaining',
      (tester) async {
        ...
        bool tapped = false;
        await tester.pumpWidget(
          testBoilerplate(OrderCard(item: vm, onTap: () => tapped = true)),
        );
    ...
    testWidgets('CancelOrderDialog enforces required cancellation reason', (
      tester,
    ) async {
    ...
    testWidgets(
      'AddPaymentDialog validates amount and handles quick-fill remaining',
      (tester) async {
    ...
    testWidgets(
      'StoreItemsDialog filters locations to only compatible and warns on conflicting items',
      (tester) async {
        final now = DateTime(2026, 9, 1);
        ...
        await tester.pumpWidget(
          testBoilerplate(
            StoreItemsDialog(
              ...
              onStore:
                  ({required orderItemIds, required storageLocationId}) async {
    ...
    testWidgets(
      'AddCustomerDialog renders in constrained height viewport without overflowing',
      (tester) async {
